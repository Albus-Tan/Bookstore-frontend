...
import {getUserConsumeResultByUserId} from "../../../services/orderService";
...
export class BookConsumeAnalysis extends React.Component{
    ...
    updateData(dateString){
        const callback = (data) => {
            ...
            const processed = data.map((b)=>{++i; return {...b,rank:i,} })
            this.setState({data: processed.filter((b) => b.num_sales > 0)});
        }
        ...
        return (data === null) ? (<></>) : (
            <div>
                <div style={{clear:"both", paddingTop:"30px",paddingLeft:"20px",}}>
                    <h1 style={{float:'left', textAlign:"left", fontSize:"28px",fontFamily:"Arial",fontWeight:"Bold", color:"#696969",}}>My Book Consume Analysis</h1>
